...
│   │   │
│   │   ├── referral/               # 推薦管理
│   │   │   ├── ReferralListPage.tsx
│   │   │   ├── ReferralDetailPage.tsx
│   │   │   ├── ReferralStatsPage.tsx
│   │   │   └── components/
│   │   │       ├── ReferralSearchForm.tsx
│   │   │       ├── ReferralTable.tsx
│   │   │       └── ReferralStatsChart.tsx
│   │   │
│   │   ├── event/                  # 活動管理
│   │   │   ├── EventListPage.tsx
│   │   │   ├── EventDetailPage.tsx
...
| 店鋪管理 | 店鋪列表 | /shop | 全部店鋪 |
| 推薦管理 | 推薦記錄 | /referral | 全部推薦記錄 |
| | 推薦統計 | /referral/stats | 推薦數據統計 |
...
| 元素 | 說明 |
|------|------|
| 搜尋條件 | 推薦人姓名、接收人姓名、被推薦人姓名、狀態、商會、日期範圍 |
| 列表欄位 | 推薦人、接收人、被推薦人、公司、狀態、建立時間、操作 |
| 操作按鈕 | 查看詳情 |
